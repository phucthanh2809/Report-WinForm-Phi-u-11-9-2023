    ...
    private string RdVanDeSauSanh()
        ...
        private void ThemThongTinPhieu()
        {
            ...
            msql = "INSERT INTO [dbo].[PhieuThamKhaoBenhNhanTruocKhiGayMeGiaiPhau] " +
                   ...
                   "VALUES (N'" + txtTenBenNhan.Text + "','" + txtTuoi.Text + "','" + txtCanNang.Text + "','" 
                   + txtChieuCao.Text + "',N'" + txtDiaChi.Text + "','" + VanDeSauSanh + "',N'" + Laygiatri(VanDeSauSanh,txtVanDeSauSanh) + 
                   "','" + GiaiPhau + "','" + LayDateTime(GiaiPhau, dtNgayMo) + "','" + Laygiatricbb(GiaiPhau, cboPT) + 
                   "','"+ Laygiatricbb(GiaiPhau, cboBV) + "','"+Suyen+ "','" + ChamMeDayNguaNgoaiDa + "','" + DiUngThuocThucPham + "',N'" + Laygiatri(DiUngThuocThucPham, txtDiUngThuoc) + 
                   "','"+ BienChungGayMe + "','" + NamVien + "',N'" + Laygiatri(NamVien, txtLyDoNamVien) + "','" + SotCaoCoGiat +
                   "','" + DongKinh + "',N'" + Laygiatri(DongKinh, txtDaDuocDieuTri) + "'," +
                   "'"+ ChayMauCam + "','"+ AnhEmHo + "','" + MacBenhTim + "',N'" + Laygiatri(MacBenhTim, txtNeuRoBenhTim) + "','" + TruyenMau + 
                   "','" + DungThuoc + "',N'" + Laygiatri(DungThuoc, txtXinNeuRoDungThuoc) + "','" + DungThuoc15Ngay + "',N'" + Laygiatri(DungThuoc15Ngay, txtKhangSinhTT) + 
                   "',N'" + Laygiatri(DungThuoc15Ngay, txtKhangSinhLD) + "',N'" + Laygiatri(DungThuoc15Ngay, txtChongViemTT) + "',N'" + Laygiatri(DungThuoc15Ngay, txtChongViemLD) + "',N'" + Laygiatri(DungThuoc15Ngay, txtHaSotTT) + 
                   "',N'" + Laygiatri(DungThuoc15Ngay, txtHaSotLD) + "',N'" + Laygiatri(DungThuoc15Ngay, txtThuocKhacTT) + "',N'" + Laygiatri(DungThuoc15Ngay, txtThuocKhacLD) + "',N'" + txtVanDeKhac.Text + 
                   "','" + Convert.ToDateTime(dtNgayThangNam.Value).ToString("yyyy-MM-dd") + "')";
        ...
        private void SuaThongTinPhieu()
        {
            ...
            msql = "UPDATE [dbo].[PhieuThamKhaoBenhNhanTruocKhiGayMeGiaiPhau]" +
                   "SET [HoTenBN] = N'" + txtTenBenNhan.Text + "',[Tuoi] = '" + txtTuoi.Text + "',[CanNang] = '" + txtCanNang.Text + "',[ChieuCao] = '" + txtChieuCao.Text + 
                   "',[DiaChi] = N'" + txtDiaChi.Text + "',[VanDeSauSanh] = '" + VanDeSauSanh + "',[TenVanDeSauSanh] = N'" + Laygiatri(VanDeSauSanh, txtVanDeSauSanh) + "',[DaGayMeGiaiPhau] = '" + GiaiPhau + 
                   "',[NgayMoGayMeGiaiPhau] = '" + LayDateTime(GiaiPhau,dtNgayMo) + "',[PhauThuatGayMeGiaiPhau] = '" + Laygiatricbb(GiaiPhau,cboPT) + 
                   "',[BenhVienGayMeGiaiPhau] = '" + Laygiatricbb(GiaiPhau,cboBV) + "',[Suyen] = '" + Suyen + "',[ChamNoiMeDayNguaNgoaiDa] = '" + ChamMeDayNguaNgoaiDa + "',[DiUngThuocThucPham] = '" + 
                   DiUngThuocThucPham + "',[TenDiUngThuocThucPham] = N'" + Laygiatri(DiUngThuocThucPham,txtDiUngThuoc) + "',[BienChungHoHangGayMeGiaiPhau] = '" + BienChungGayMe + 
                   "',[DaNamVien] = '" + NamVien + "',[LiDoNamVien] = N'" + Laygiatri(NamVien, txtLyDoNamVien) + "'," +
                   "[SotCaoCoGiat] = '" + SotCaoCoGiat + "',[DongKinh] = '" + DongKinh + "',[DaDieuTriDongKinh] = N'" + Laygiatri(DongKinh, txtDaDuocDieuTri) + 
                   "',[ChayMauCamhChayMauKeoDaihBamTimChanThuong] = '" + ChayMauCam + "',[AnhEmHoRuotBiChayMauKeoDai] = '" + AnhEmHo + "',[TimBamSinhhViemPheQuanhVangDahBenhThan] = '" + MacBenhTim + 
                   "',[NeuRoTimBamSinhhViemPheQuanhVangDahBenhThan] = N'" + Laygiatri(MacBenhTim,txtNeuRoBenhTim) + "',[DaTungTruyenMau] = '" + TruyenMau + "',[DungThuocThuongXuyen] = '" + DungThuoc + 
                   "',[NeuRoThuocDungThuongXuyen] = N'" + Laygiatri(DungThuoc,txtXinNeuRoDungThuoc) + "',[ThuocDungHienTaiTu15NgayTroLai] = '" 
                   + DungThuoc15Ngay + "',[TenThuocKhangSinh] = N'" + Laygiatri(DungThuoc15Ngay, txtKhangSinhTT) + 
                   "',[LieuDungKhangSinh] = N'" + Laygiatri(DungThuoc15Ngay, txtKhangSinhLD) + "',[TenThuocChongViem] = N'" + Laygiatri(DungThuoc15Ngay, txtChongViemTT) + "',[LieuDungChongViem] = N'" + 
                   Laygiatri(DungThuoc15Ngay, txtChongViemLD) + "',[TenThuocHaSotGiamDau] = N'" + Laygiatri(DungThuoc15Ngay, txtHaSotTT) + "'," +
                   "[LieuDungHaSotGiamDau] = N'" + Laygiatri(DungThuoc15Ngay, txtHaSotLD) + "',[TenThuocThuocKhac] = N'" + Laygiatri(DungThuoc15Ngay, txtThuocKhacTT) + 
                   "',[LieuDungThuocKhac] = N'" + Laygiatri(DungThuoc15Ngay, txtThuocKhacLD) + 
                   "',[LuuYChoBSGayMeHoiSuc] = N'" + txtVanDeKhac.Text + "',[NgayThangNam] = '" + Convert.ToDateTime(dtNgayThangNam.Value).ToString("yyyy-MM-dd") + 
                   "'WHERE MaPhieuThamKhaoBNTruocKhiGayMeGiaiPhau = '" + txtMaPhieu.Text + "'";
            comm.RunSQL(mconnectstring, msql);
        }
        String Laygiatri(string s, TextBox txt)
        {
            try
            {
        ...
        String Laygiatricbb (string s, ComboBox txt)
        {
            try
            {
                int b = Convert.ToInt32(s);
        ...
        String LayDateTime(string s, DateTimePicker txt)
        {
            try
            {
                int b = Convert.ToInt32(s);
                if (b == 1)
                {
                    return Convert.ToDateTime(txt.Value).ToString("yyyy-MM-dd");
                }
                return "";
            }
            catch (Exception)
